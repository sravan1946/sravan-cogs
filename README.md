...
| Quoter         | 1.0.0            | <details><summary>Send quote embeds with optional author</summary>Sends quote embeds to a configured guild channel. Use `quoteset` to set the destination channel and optionally enable auto-deletion for the interactive prompt; `quote` posts the quote and lets the user optionally pick an author.</details> | sravan                                         |
