# yoinked from https://github.com/TrustyJAID/Trusty-cogs/blob/master/notsobot/converter.py

import re
from typing import List, Pattern, Union, cast
...
class ImageFinder(Converter):
    """
    This is a class to convert dankimgen's image searching capabilities
