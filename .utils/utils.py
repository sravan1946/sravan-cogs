# taken from https://github.com/TrustyJAID/Trusty-cogs/blob/master/.utils/utils.py & https://github.com/phenom4n4n/phen-cogs/blob/master/.utils/utils.py
import glob
import json
import logging
import os
